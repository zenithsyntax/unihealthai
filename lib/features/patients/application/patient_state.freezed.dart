...
mixin _$PatientState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is PatientState);
  }
...
class _Success implements PatientState {
  const _Success(final List<PatientEntity> patients) : _patients = patients;
  ...
  @override
  String toString() {
    return 'PatientState.success(patients: $patients)';
  }
}
...
class _Failure implements PatientState {
  ...
  @override
  String toString() {
    return 'PatientState.failure(failure: $failure)';
  }
}
